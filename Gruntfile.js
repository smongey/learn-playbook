    ...
    buildcontrol: {
      dist: {
        options: {
          ...
          remote: 'git@github.com:smongey/learn-playbook.git',
          branch: 'gh-pages'
        }
      }
    },
      ...
      dist: {
        options: {
          patterns: [
            {
              match: /("|'?)\/?assets\//g,
              replacement: '$1http://smongey.github.io/learn-playbook/assets/'
            },
            {
              match: /(<a[^>]*href="?)(\/)/g,
              replacement: '$1http://smongey.github.io/learn-playbook/'
            },
            {
              match: /(<form[^>]*action="?)(\/)/g,
              replacement: '$1http://smongey.github.io/learn-playbook/'
